...
@section('Contenido')
<div class="card mt-5" style="width: 40rem; position: relative; top: 5%; left: 25%;">
    <div class="card-body">
      <h2 class="card-title ml-5" style="position: relative; left: 30%;">Modificar Oferta</h2>
      <div class="card-body">
            @php
